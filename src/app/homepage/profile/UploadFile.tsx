...
//   const uploadButton = (
//     <button className='flex flex-col gap-y-2 items-center text-primary' type="button" >
//       <FaImage className='h-8 w-8'/>
//       <div onClick={() => uploadAvatar(fileList)}>+ Upload Image</div>
//     </button>
//   );
//   return (
//     <>
...
const UploadFile: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    if (file) {
      try {
        ...
        // Optionally, handle the UI state after successful upload
      } catch (error) {
  ...
  const handleDownloadAvatar = async () => {
    try {
      ...
      // Optionally, handle the UI state after successful download
    } catch (error) {
      console.log("an error occured");
